...
<div class="flex flex-col items-center mx-auto">
	...
	<p>
		Visit <a href="https://kit.svelte.dev" class="underline text-blue-400 hover:text-blue-600"
			>kit.svelte.dev</a
	...
	{#if selectedRcs === -1}
		<input type="number" min="0" bind:value={customRcs} class="rounded outline outline-1"/>
	{/if}
	<input type="range" min="0" max="10000" step="10" bind:value={slider} class="w-1/2" />
	<p>Slider is at:</p>
	<input type="number" min="0" max="10000" bind:value={slider} class="rounded outline outline-1" />
	<p>{maybe}</p>
